...
class LoadingViewHolder extends RecyclerView.ViewHolder{
    ...
    public LoadingViewHolder(@NonNull View itemView) {
        super(itemView);
        progressBar = itemView.findViewById(R.id.progress_baryes);
    }
}
...
public class DynamicRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private  final int VIEW_TYPE_ITEM = 0,VIEW_TAPE_LOADING = 1;
    LoadMore loadMore;
    boolean isLoading;
    Activity activity;
    ...
    public int getItemViewType(int position) {
        ...
        return items.get(position) == null ? VIEW_TAPE_LOADING:VIEW_TYPE_ITEM;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        else if (viewType == VIEW_TAPE_LOADING){
